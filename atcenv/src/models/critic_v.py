...
class RelDistTransformerV(Critic_V):
...
class OwnRefTransformerV(Critic_V):
...
class OwnRefTransformerSkipV(Critic_V):
...
class AbsTransformerV(Critic_V):
...
class TransformerTestV(Critic_V):
    def __init__(self,
                 q_dim: int,
                 kv_dim: int,
                 num_heads: int = 3,
...
class MultiHeadAdditiveCriticV(Critic_V):
    def __init__(self,
                 q_dim: int,
                 kv_dim: int,
                 num_heads: int = 3,
...
class MultiHeadAdditiveCriticVBasic(Critic_V):
    def __init__(self,
                 q_dim: int,
                 kv_dim: int,
                 num_heads: int = 3,
